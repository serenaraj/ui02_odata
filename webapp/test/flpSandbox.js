		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI5 Application with OData",
									"targetURL": "#comrizingui5sr01ui02odata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comrizingui5sr01ui02odata-display": {
								"semanticObject": "comrizingui5sr01ui02odata",
								"action": "display",
								"description": "UI5 Application with Odata",
								"title": "UI5 Application with OData",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.rizing.ui5.sr01.ui02odata",
									"url": sap.ui.require.toUrl("com/rizing/ui5/sr01/ui02odata")
								}
							}
						}
					}
